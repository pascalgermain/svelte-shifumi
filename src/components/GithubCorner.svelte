<script lang="ts">
  ...
  export let background = '#25292e'
  export let color = '#fff'

  $: href = `https://github.com/${url}`
  $: style = `fill: ${background}; color: ${color};`
</script>
...
<a {href} aria-label="View source on GitHub" target="_blank" rel="noopener">
  <svg viewBox="0 0 250 250" {style} aria-hidden="true">
